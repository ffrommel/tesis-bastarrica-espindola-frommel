...
<!--INDEX.tpl-->
    <head>
        ...
        <script type="text/javascript" src="/Tesis/JavaScript/forecast.js"></script>
    ...
    <body>
        ...
        <div style="text-align: center">    
            <label id="loadingLabelForecast" class="loadingLabels"></label>
        </div>
        <div id="showForecast" style="text-align:center">
